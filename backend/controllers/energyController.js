...
exports.reduceEnergy = async (req, res) => {
  try {
    ...
    //console.log('Reducing energy for:', user_id);
    ...
    //console.log('Current energy:', user_energy);
    ...
    //console.log('Calculated energy:', user_energy);

    // Update with diagnostic
    ...
    console.error('Error in reduceEnergy:', err);
    res.status(500).json({ error: 'Internal server error' });
  }
};