...
with_node \
  ...
  --target "/Users/yoac/Documents/WMDD/INTAKE4/CAPSTONE_PROJECT/Bubbl/ios/Pods/Target Support Files/Pods-Bubbl/ExpoModulesProvider.swift" \
  --entitlement "/Users/yoac/Documents/WMDD/INTAKE4/CAPSTONE_PROJECT/Bubbl/ios/Bubbl/Bubbl.entitlements" \
  --platform "apple" \
  --packages "expo" "expo-asset" "expo-constants" "expo-dev-launcher" "expo-dev-menu" "expo-file-system" "expo-font" "expo-keep-awake" "expo-local-authentication"
